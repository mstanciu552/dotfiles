...
_G.packer_plugins = {
  ...
  ["cmp-matlab"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/cmp-matlab",
  ...
  ["cmp-octave"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/cmp-octave",
  ...
  lsp_matlab = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/lsp_matlab",
