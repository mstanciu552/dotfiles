...
globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "d", function()
		awful.util.spawn(os.getenv("HOME") .. "/bin/rofi-bluetooth")
	end), -- rofi
	...
	awful.key({ modkey, "Control" }, "f", function()
		awful.util.spawn(os.getenv("HOME") .. "/bin/bright_fix")
	end),
